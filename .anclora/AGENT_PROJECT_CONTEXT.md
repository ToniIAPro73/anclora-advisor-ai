# Anclora Advisor Ai — Agent Project Context
...
APPLICATION_NAME=Anclora Advisor Ai
REPOSITORY=anclora-advisor-ai
...
- **PRODUCTION_RUNTIME**: [`.anclora/PRODUCTION_RUNTIME.md`](PRODUCTION_RUNTIME.md)
  - Governs real runtime architecture, hosting, Supabase database connection, SUPABASE_DASHBOARD_OR_CLI migration strategy, auth, and production-backed local model.
...
| **Database / Migrations** | [`.anclora/PRODUCTION_RUNTIME.md`](PRODUCTION_RUNTIME.md) | `./supabase/migrations` |
